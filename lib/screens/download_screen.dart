            ...
            children: [
              ...
              Text(
                _hasError && _noInternet
                    ? 'Connect to WiFi or mobile data to download PocketAI (2.19 GB). After this, no internet is needed.'
                    : _hasError
                        ? 'Download interrupted. Your progress is saved — tap Retry to continue.'
                        : _isDownloading
                            ? 'Downloading the AI model. This only happens once — after this, PocketAI works fully offline.'
