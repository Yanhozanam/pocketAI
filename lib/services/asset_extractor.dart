...
class AssetExtractor {
  static const _channel = MethodChannel('com.besmartai.app/asset_extractor');

  static Future<bool> extractTo({
    ...
    try {
      final result = await _channel.invokeMethod<String>('extractModel', {
        'assetPath': assetPath,
